...
const rv_opcode_data opcode_data[] = {
    ...
    [rv_op_cgetmte] = { "cgetmte", rv_codec_r, rv_fmt_rd_cs1, NULL, 0, 0, 0 },
    [rv_op_cgettloc] = { "cgettloc", rv_codec_r, rv_fmt_rd_cs1, NULL, 0, 0, 0 },
    [rv_op_cgetmemmte] = { "cgetmemmte", rv_codec_r, rv_fmt_rd_cs1, NULL, 0, 0, 0 },
    [rv_op_cgettmode] = { "cgettmode", rv_codec_r, rv_fmt_rd_cs1, NULL, 0, 0, 0 },
    ...
    [rv_op_csetmte] = { "csetmte", rv_codec_r, rv_fmt_cd_cs1_rs2, NULL, 0, 0, 0 },
    [rv_op_csettmode] = { "csettmode", rv_codec_r, rv_fmt_cd_cs1_rs2, NULL, 0, 0, 0 },
    [rv_op_csettloc] = { "csettloc", rv_codec_r, rv_fmt_cd_cs1_rs2, NULL, 0, 0, 0 },
    [rv_op_csetmemmte] = { "csetmemmte", rv_codec_r, rv_fmt_cd_cs1_rs2, NULL, 0, 0, 0 },
...
static rv_opcode decode_cheri_two_op(unsigned func) {
    ...
    case 0b11000: return rv_op_cgetmte;
    case 0b11001: return rv_op_cgettloc;
    case 0b11010: return rv_op_cgetmemmte;
    case 0b11011: return rv_op_cgettmode;
...
static rv_opcode decode_cheri_inst(rv_inst inst) {
    ...
    CHERI_THREEOP_CASE(csetmte,     0010111,  ..... ..... 000 ..... 1011011 @r)
    CHERI_THREEOP_CASE(csettloc,    0011000,  ..... ..... 000 ..... 1011011 @r)
    CHERI_THREEOP_CASE(csetmemmte,    0011001,  ..... ..... 000 ..... 1011011 @r)
    CHERI_THREEOP_CASE(csettmode,    0011010,  ..... ..... 000 ..... 1011011 @r)
