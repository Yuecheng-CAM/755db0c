...
class MOD_mkSoC_Map : public Module {
 ...
 public:
  ...
  tUWide PORT_m_uart0_addr_range;
  tUWide PORT_m_boot_rom_addr_range;
  tUWide PORT_m_mem0_controller_addr_range;
  tUWide PORT_m_tcm_addr_range;
 ...
 public:
  ...
  tUWide METH_m_uart0_addr_range();
  tUInt8 METH_RDY_m_uart0_addr_range();
  tUWide METH_m_boot_rom_addr_range();
  tUInt8 METH_RDY_m_boot_rom_addr_range();
  tUWide METH_m_mem0_controller_addr_range();
  tUInt8 METH_RDY_m_mem0_controller_addr_range();
  tUWide METH_m_tcm_addr_range();
  tUInt8 METH_RDY_m_tcm_addr_range();
  tUInt8 METH_m_is_mem_addr(tUInt64 ARG_m_is_mem_addr_addr);
  tUInt8 METH_RDY_m_is_mem_addr();
  tUInt8 METH_m_is_IO_addr(tUInt64 ARG_m_is_IO_addr_addr, tUInt8 ARG_m_is_IO_addr_imem_not_dmem);
