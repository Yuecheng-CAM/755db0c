...
module mkMMIOInst(CLK,
  ...
  // inlined wires
  wire [68 : 0] respQ_enqReq_lat_0$wget, respQ_enqReq_lat_2$wget;
  wire [66 : 0] reqQ_enqReq_lat_0$wget, reqQ_enqReq_lat_2$wget;
  ...
  wire IF_reqQ_enqReq_lat_1_whas_THEN_reqQ_enqReq_lat_ETC___d35,
       IF_respQ_enqReq_lat_1_whas__4_THEN_respQ_enqRe_ETC___d96;
  ...
  assign getFetchTarget =
		 ...
		 getFetchTarget_phyPc[63:3] < 61'd805306368 &&
  ...
  assign reqQ_data_0$EN =
	     !reqQ_clearReq_rl &&
	     IF_reqQ_enqReq_lat_1_whas_THEN_reqQ_enqReq_lat_ETC___d35 ;
  ...
  // remaining internal signals
  assign IF_reqQ_enqReq_lat_1_whas_THEN_reqQ_enqReq_lat_ETC___d35 =
	     EN_bootRomReq ? reqQ_enqReq_lat_0$wget[66] : reqQ_enqReq_rl[66] ;
  assign IF_respQ_enqReq_lat_1_whas__4_THEN_respQ_enqRe_ETC___d96 =
	     EN_toCore_instResp_enq ?
	       respQ_enqReq_lat_0$wget[68] :
	       respQ_enqReq_rl[68] ;
