...
//
// On Sun May 31 11:20:04 BST 2026
//
//
// Ports:
// Name                         I/O  size props
...
module mkJtagTap(CLK,
  ...
  reg [39 : 0] CASE_newir509_0_1_1_2147483648_0x10_2147483648_ETC__q1,
	       v__h2355;
  reg [4 : 0] newir__h3509;
  ...
  wire [39 : 0] IF_r_dmistat_busy_port0__read__46_OR_NOT_r_dmi_ETC___d149,
		...
		x__h2875,
		y__h2876;
  wire [4 : 0] v__h3377, x__h3422, y__h3423;
  ...
  assign r_drmask$D_IN =
	     (r_state$Q_OUT == 4'd3) ?
	       CASE_newir509_0_1_1_2147483648_0x10_2147483648_ETC__q1 :
	       r_drmask ;
  ...
  assign r_state__read_EQ_8_8_AND_r_ir_3_EQ_0x11_1_AND__ETC___d78 =
	     ...
	     r_dmi$Q_OUT[1:0] != 2'd3 &&
	     !f_dmi_busy$EMPTY_N ;
  assign v__h2452 = { 35'd7864320, r_ir } ;
  ...
  assign x__h3422 = { 1'd0, r_ir[4:1] } ;
  assign y__h2876 = jtag_tdi ? r_drmask : 40'd0 ;
  assign y__h3423 = jtag_tdi ? 5'd16 : 5'd0 ;
  always@(r_state$Q_OUT or r_ir or v__h3377)
  begin
    case (r_state$Q_OUT)
      4'd0: newir__h3509 = 5'd1;
  ...
  begin
    case (r_ir)
      5'd0, 5'h12, 5'h13, 5'h14, 5'h15, 5'h16, 5'h17, 5'd31: v__h2355 = 40'd0;
      5'd1: v__h2355 = 40'd4093;
      5'h10: v__h2355 = x__h2674;
      5'h11:
	  v__h2355 =
	      IF_r_dmistat_busy_port0__read__46_OR_NOT_r_dmi_ETC___d149;
  ...
  begin
    case (newir__h3509)
	  ...
	  CASE_newir509_0_1_1_2147483648_0x10_2147483648_ETC__q1 = 40'd1;
      5'd1, 5'h10:
	  CASE_newir509_0_1_1_2147483648_0x10_2147483648_ETC__q1 =
	      40'h0080000000;
      5'h11:
	  CASE_newir509_0_1_1_2147483648_0x10_2147483648_ETC__q1 =
	      40'h8000000000;
      default: CASE_newir509_0_1_1_2147483648_0x10_2147483648_ETC__q1 =
		   40'h0100000000;
    endcase
  end
