...
//
// On Sun May 31 11:22:34 BST 2026
//
//
// Ports:
// Name                         I/O  size props
...
module mkAluRegToExeFifo(CLK,
  ...
  reg [4 : 0] CASE_enq_x_BITS_783_TO_779_0_enq_x_BITS_778_TO_ETC__q2,
	      CASE_m_m_row_0_BITS_771_TO_767_0_m_m_row_0_BIT_ETC__q1;
  ...
  assign m_m_row_0$D_IN =
		 ...
		 enq_x[785:774] :
		 { enq_x[785:779],
		   CASE_enq_x_BITS_783_TO_779_0_enq_x_BITS_778_TO_ETC__q2 },
	       enq_x[773:12] } ;
  ...
  always@(m_m_row_0)
  begin
    case (m_m_row_0[771:767])
      5'd0, 5'd1, 5'd2, 5'd3:
	  CASE_m_m_row_0_BITS_771_TO_767_0_m_m_row_0_BIT_ETC__q1 =
	      m_m_row_0[766:762];
      default: CASE_m_m_row_0_BITS_771_TO_767_0_m_m_row_0_BIT_ETC__q1 =
		   m_m_row_0[766:762];
    endcase
  end
  always@(enq_x)
  begin
    case (enq_x[783:779])
	  ...
	  CASE_enq_x_BITS_783_TO_779_0_enq_x_BITS_778_TO_ETC__q2 =
	      enq_x[778:774];
      default: CASE_enq_x_BITS_783_TO_779_0_enq_x_BITS_778_TO_ETC__q2 =
		   enq_x[778:774];
    endcase
  end
  ...
  begin
    m_m_row_0 =
	813'h0AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA;
