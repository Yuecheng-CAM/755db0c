...
module mkEpochManager(CLK,
  ...
  wire [3 : 0] _theResult____h2911, checkedEpoch__h2957, next_epoch__h81;
  wire IF_IF_updatePrevEn_0_lat_0_whas_THEN_updatePre_ETC___d59,
       IF_IF_updatePrevEn_1_lat_0_whas__0_THEN_NOT_up_ETC___d24,
       IF_updatePrevEn_0_lat_0_whas_THEN_updatePrevEn_ETC___d22,
       IF_updatePrevEn_1_lat_0_whas__0_THEN_NOT_updat_ETC___d19,
       IF_updatePrevEn_1_lat_0_whas__0_THEN_NOT_updat_ETC___d28,
       NOT_IF_IF_updatePrevEn_0_lat_0_whas_THEN_updat_ETC___d61,
       NOT_prev_checked_epoch_6_ULE_updatePrevEpoch_0_ETC___d49,
       NOT_updatePrevEpoch_0_update_e_ULE_curr_epoch_4_0___d51,
       NOT_updatePrevEpoch_1_update_e_ULE_curr_epoch_4_2___d63,
       prev_checked_epoch_6_ULE_curr_epoch_4___d47;
  ...
  // remaining internal signals
  assign IF_IF_updatePrevEn_0_lat_0_whas_THEN_updatePre_ETC___d59 =
	     _theResult____h2911 <= curr_epoch ;
  assign IF_IF_updatePrevEn_1_lat_0_whas__0_THEN_NOT_up_ETC___d24 =
	     IF_updatePrevEn_1_lat_0_whas__0_THEN_NOT_updat_ETC___d19 ?
	       IF_updatePrevEn_0_lat_0_whas_THEN_updatePrevEn_ETC___d22 :
	       (EN_updatePrevEpoch_1_update ?
		  updatePrevEn_1_lat_0$wget[4] :
		  updatePrevEn_1_rl[4]) ;
  assign IF_updatePrevEn_0_lat_0_whas_THEN_updatePrevEn_ETC___d22 =
	     EN_updatePrevEpoch_0_update ?
	       updatePrevEn_0_lat_0$wget[4] :
	       updatePrevEn_0_rl[4] ;
  assign IF_updatePrevEn_1_lat_0_whas__0_THEN_NOT_updat_ETC___d19 =
	     EN_updatePrevEpoch_1_update ?
	       !updatePrevEn_1_lat_0$wget[4] :
	       !updatePrevEn_1_rl[4] ;
  assign IF_updatePrevEn_1_lat_0_whas__0_THEN_NOT_updat_ETC___d28 =
	     IF_updatePrevEn_1_lat_0_whas__0_THEN_NOT_updat_ETC___d19 &&
	     (EN_updatePrevEpoch_0_update ?
		!updatePrevEn_0_lat_0$wget[4] :
		!updatePrevEn_0_rl[4]) ;
  assign NOT_IF_IF_updatePrevEn_0_lat_0_whas_THEN_updat_ETC___d61 =
	     _theResult____h2911 > updatePrevEpoch_1_update_e ;
  assign NOT_prev_checked_epoch_6_ULE_updatePrevEpoch_0_ETC___d49 =
	     prev_checked_epoch > updatePrevEpoch_0_update_e ;
  assign NOT_updatePrevEpoch_0_update_e_ULE_curr_epoch_4_0___d51 =
	     updatePrevEpoch_0_update_e > curr_epoch ;
  assign NOT_updatePrevEpoch_1_update_e_ULE_curr_epoch_4_2___d63 =
	     updatePrevEpoch_1_update_e > curr_epoch ;
  assign _theResult____h2911 =
	     IF_updatePrevEn_0_lat_0_whas_THEN_updatePrevEn_ETC___d22 ?
	       checkedEpoch__h2957 :
	       prev_checked_epoch ;
  assign checkedEpoch__h2957 =
	     EN_updatePrevEpoch_0_update ?
	       updatePrevEn_0_lat_0$wget[3:0] :
	       updatePrevEn_0_rl[3:0] ;
  assign next_epoch__h81 = (curr_epoch == 4'd11) ? 4'd0 : curr_epoch + 4'd1 ;
  assign prev_checked_epoch_6_ULE_curr_epoch_4___d47 =
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  IF_IF_updatePrevEn_0_lat_0_whas_THEN_updatePre_ETC___d59 &&
	  (NOT_IF_IF_updatePrevEn_0_lat_0_whas_THEN_updat_ETC___d61 ||
	   NOT_updatePrevEpoch_1_update_e_ULE_curr_epoch_4_2___d63))
	$fdisplay(32'h80000002, "\n%m: ASSERT FAIL!!");
    if (RST_N != `BSV_RESET_VALUE)
	...
	$fdisplay(32'h80000002, "\n%m: ASSERT FAIL!!");
    if (RST_N != `BSV_RESET_VALUE)
      if (IF_IF_updatePrevEn_1_lat_0_whas__0_THEN_NOT_up_ETC___d24 &&
	  IF_updatePrevEn_1_lat_0_whas__0_THEN_NOT_updat_ETC___d28)
	$fdisplay(32'h80000002, "\n%m: ASSERT FAIL!!");
  end
  // synopsys translate_on
