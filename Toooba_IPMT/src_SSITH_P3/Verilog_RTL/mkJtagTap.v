...
//
// On Sun May 31 11:20:01 BST 2026
//
//
// Ports:
// Name                         I/O  size props
...
module mkJtagTap(CLK,
  ...
  reg [39 : 0] CASE_newir509_0_1_1_2147483648_0x12_1_0x13_1_0_ETC__q1,
	       v__h2355;
  reg [17 : 0] newir__h3509;
  reg [3 : 0] CASE_r_stateQ_OUT_0_1_1_1_2_3_3_4_4_4_5_6_6_6_ETC__q3,
	      CASE_r_stateQ_OUT_0_r_stateQ_OUT_1_2_2_9_3_5_ETC__q2;
  wire [39 : 0] IF_r_dmistat_busy_port0__read__46_OR_NOT_r_dmi_ETC___d149,
		v__h2452,
		v__h2826,
		x__h2595,
		x__h2674,
		x__h2875,
		y__h2876;
  wire [17 : 0] v__h3377, x__h3422, y__h3423;
  ...
  // register r_dr
  always@(r_state$Q_OUT or r_dr or v__h2355 or v__h2826)
  begin
    case (r_state$Q_OUT)
      4'd0: r_dr$D_IN = r_dr;
      4'd3: r_dr$D_IN = v__h2355;
      4'd4: r_dr$D_IN = v__h2826;
  ...
  assign r_drmask$D_IN =
	     (r_state$Q_OUT == 4'd3) ?
	       CASE_newir509_0_1_1_2147483648_0x12_1_0x13_1_0_ETC__q1 :
	       r_drmask ;
  assign r_drmask$EN = 1'd1 ;

  // register r_ir
  assign r_ir$D_IN = newir__h3509 ;
  assign r_ir$EN = 1'd1 ;
  ...
  // remaining internal signals
  assign IF_r_dmistat_busy_port0__read__46_OR_NOT_r_dmi_ETC___d149 =
	     (r_dmistat_busy ||
  ...
  assign r_state__read_EQ_8_8_AND_r_ir_3_EQ_0b111001001_ETC___d78 =
	     ...
	     r_dmi$Q_OUT[1:0] != 2'd3 &&
	     !f_dmi_busy$EMPTY_N ;
  assign v__h2452 = { 22'd960, r_ir } ;
  assign v__h2826 = x__h2875 | y__h2876 ;
  assign v__h3377 = x__h3422 | y__h3423 ;
  assign x__h2595 =
	     { 6'bxxxxxx /* unspecified value */ ,
	       32'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */ ,
	       2'd3 } ;
  assign x__h2674 = { 28'd0, r_dmi$Q_OUT[1:0], 10'd97 } ;
  assign x__h2875 = { 1'd0, r_dr[39:1] } ;
  assign x__h3422 = { 1'd0, r_ir[17:1] } ;
  assign y__h2876 = jtag_tdi ? r_drmask : 40'd0 ;
  assign y__h3423 = jtag_tdi ? 18'd131072 : 18'd0 ;
  always@(r_state$Q_OUT or r_ir or v__h3377)
  begin
    case (r_state$Q_OUT)
      4'd0: newir__h3509 = 18'd1;
      4'd3, 4'd4, 4'd8: newir__h3509 = r_ir;
      4'd11: newir__h3509 = v__h3377;
      default: newir__h3509 = r_ir;
    endcase
  end
  always@(r_ir or
	  v__h2452 or
	  IF_r_dmistat_busy_port0__read__46_OR_NOT_r_dmi_ETC___d149 or
	  x__h2674)
  begin
    case (r_ir)
      18'd0,
      ...
      18'd262143:
	  v__h2355 = 40'd0;
      18'd1: v__h2355 = 40'd4093;
      18'b000011100100100100:
	  v__h2355 =
	      IF_r_dmistat_busy_port0__read__46_OR_NOT_r_dmi_ETC___d149;
      18'b100010100100100100: v__h2355 = x__h2674;
      default: v__h2355 = v__h2452;
    endcase
  end
  always@(newir__h3509)
  begin
    case (newir__h3509)
      ...
      18'h00017,
      18'd262143:
	  CASE_newir509_0_1_1_2147483648_0x12_1_0x13_1_0_ETC__q1 = 40'd1;
	  ...
	  CASE_newir509_0_1_1_2147483648_0x12_1_0x13_1_0_ETC__q1 =
	      40'h8000000000;
      default: CASE_newir509_0_1_1_2147483648_0x12_1_0x13_1_0_ETC__q1 =
		   40'h0100000000;
    endcase
  end
