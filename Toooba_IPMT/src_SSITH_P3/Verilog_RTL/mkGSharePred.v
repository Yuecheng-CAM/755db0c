...
module mkGSharePred(CLK,
  ...
  wire [16 : 0] pred_0_pred, pred_1_pred;
  wire RDY_flush,
       RDY_flush_done,
       RDY_nextPc,
       RDY_pred_0_pred,
  ...
  wire [7 : 0] gHist__h1978,
	       gHist__h2307,
	       index__h1979,
	       index__h2308,
	       pcIdx__h2476,
	       pc_reg_BITS_7_TO_0_PLUS_4__q1;
  ...
  // actionvalue method pred_0_pred
  assign pred_0_pred = { tab$D_OUT_3[1], gHist__h1978, index__h1979 } ;
  assign RDY_pred_0_pred = 1'd1 ;
  assign CAN_FIRE_pred_0_pred = 1'd1 ;
  assign WILL_FIRE_pred_0_pred = EN_pred_0_pred ;

  // actionvalue method pred_1_pred
  assign pred_1_pred = { tab$D_OUT_2[1], gHist__h2307, index__h2308 } ;
  ...
  assign globalHist$addHistory_taken =
	     EN_pred_1_pred ?
	       upd__h1351 :
	       IF_predRes_lat_0_whas__0_THEN_IF_predRes_lat_0_ETC___d24 ;
  assign globalHist$redirect_newHist = { update_taken, update_train[15:9] } ;
  assign globalHist$EN_addHistory = 1'd1 ;
  assign globalHist$EN_redirect = EN_update && update_mispred ;

  // submodule tab
  assign tab$ADDR_1 = update_train[7:0] ;
  assign tab$ADDR_2 = gHist__h2307 ^ pcIdx__h2476 ;
  assign tab$ADDR_3 = index__h1979 ;
  assign tab$ADDR_4 = 8'h0 ;
  assign tab$ADDR_5 = 8'h0 ;
  assign tab$ADDR_IN = update_train[7:0] ;
  assign tab$D_IN =
	     update_taken ?
	       ((tab$D_OUT_1 == 2'd3) ? tab$D_OUT_1 : tab$D_OUT_1 + 2'd1) :
	       ((tab$D_OUT_1 == 2'd0) ? tab$D_OUT_1 : tab$D_OUT_1 - 2'd1) ;
  ...
  assign gHist__h2307 =
	     globalHist$history >>
	     IF_predCnt_lat_0_whas_THEN_IF_predCnt_lat_0_wh_ETC___d11 ;
  assign index__h1979 = gHist__h1978 ^ pc_reg[9:2] ;
  assign index__h2308 = gHist__h2307 ^ pcIdx__h2476 ;
  assign pcIdx__h2476 = { pc_reg[9:8], pc_reg_BITS_7_TO_0_PLUS_4__q1[7:2] } ;
  ...
  assign upd__h1351 =
	     tab$D_OUT_2[1] ?
	       ...
	       y__h2648 ;
  assign upd__h1378 =
	     tab$D_OUT_3[1] ? predRes_rl | x__h2080 : predRes_rl & y__h2269 ;
  assign upd__h759 =
