...
//
// On Sun May 31 11:17:10 BST 2026
//
//
// Ports:
// Name                         I/O  size props
...
module module_amoExec(amoExec_amo_inst,
  ...
  wire SEL_ARR_amoExec_current_BITS_31_TO_0_5_amoExec_ETC___d65,
       SEL_ARR_amoExec_current_BITS_31_TO_0_5_amoExec_ETC___d68,
       SEL_ARR_amoExec_current_BITS_63_TO_0_3_amoExec_ETC___d35,
       SEL_ARR_amoExec_current_BITS_63_TO_0_3_amoExec_ETC___d40,
       amoExec_current_BITS_127_TO_0_SLE_amoExec_inpt_ETC___d93,
       amoExec_current_BITS_127_TO_0_ULE_amoExec_inpt_ETC___d96;
  ...
  // remaining internal signals
  assign SEL_ARR_amoExec_current_BITS_31_TO_0_5_amoExec_ETC___d65 =
	     (vOld__h1130 ^ 32'h80000000) <=
	     (amoExec_inpt[31:0] ^ 32'h80000000) ;
  assign SEL_ARR_amoExec_current_BITS_31_TO_0_5_amoExec_ETC___d68 =
	     vOld__h1130 <= amoExec_inpt[31:0] ;
  ...
  assign amoExec_current_BITS_127_TO_0_SLE_amoExec_inpt_ETC___d93 =
	     (amoExec_current[127:0] ^
	      128'h80000000000000000000000000000000) <=
	     (amoExec_inpt[127:0] ^ 128'h80000000000000000000000000000000) ;
  assign amoExec_current_BITS_127_TO_0_ULE_amoExec_inpt_ETC___d96 =
  ...
  assign tmpData__h638 = { 96'd0, x__h1128 } ;
  ...
  begin
    case (amoExec_wordIdx)
      2'd0: vOld__h1130 = amoExec_current[31:0];
      2'd1: vOld__h1130 = amoExec_current[63:32];
      2'd2: vOld__h1130 = amoExec_current[95:64];
      2'd3: vOld__h1130 = amoExec_current[127:96];
    endcase
  end
  ...
  always@(amoExec_amo_inst or
	  SEL_ARR_amoExec_current_BITS_31_TO_0_5_amoExec_ETC___d68 or
	  amoExec_inpt or
	  vOld__h1130 or
	  SEL_ARR_amoExec_current_BITS_31_TO_0_5_amoExec_ETC___d65)
  begin
    case (amoExec_amo_inst[7:4])
      4'd0: x__h1128 = amoExec_inpt[31:0];
      4'd1: x__h1128 = vOld__h1130 + amoExec_inpt[31:0];
      4'd2: x__h1128 = vOld__h1130 ^ amoExec_inpt[31:0];
      4'd3: x__h1128 = vOld__h1130 & amoExec_inpt[31:0];
      4'd4: x__h1128 = vOld__h1130 | amoExec_inpt[31:0];
      4'd5:
	  x__h1128 =
	      SEL_ARR_amoExec_current_BITS_31_TO_0_5_amoExec_ETC___d65 ?
		vOld__h1130 :
  ...
  always@(amoExec_amo_inst or
	  amoExec_current_BITS_127_TO_0_ULE_amoExec_inpt_ETC___d96 or
	  amoExec_inpt or
	  amoExec_current or
	  amoExec_current_BITS_127_TO_0_SLE_amoExec_inpt_ETC___d93)
  begin
